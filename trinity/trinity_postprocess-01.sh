...
MYHIST=$LAB/scripts/.readline_trinity_args
history -r $MYHIST
history -a $MYHIST
history -n $MYHIST
...
export PBS=" -V -S /cbcb/lab/nelsayed/local/bin/bash -q long -l walltime=144:00:00 -N trin_post -jeo -e ${WD}/trinity_postprocess.stdout "
#export PBS=" -V -S /cbcb/lab/nelsayed/local/bin/bash -q high_throughput -N trinity -jeo -e ${WD}/trinity.stdout "
export TRINITY="  --seqType fq --target ./trinity_out_dir/Trinity.fasta --aligner bowtie --retain_intermediate_files "
export MYWD=$WD
export R1=" --left ${MYWD}/"
export R2=" --right ${MYWD}/"
export LOG="./trinity_post.out"
...
history -w $MYHIST
TRINITY="$PREFIX/trinity/util/alignReads.pl "
